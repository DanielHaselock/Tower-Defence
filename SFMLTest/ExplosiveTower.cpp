...
using namespace TD;
void ExplosiveTower::Update(TD::EnemyArmy& EnemyArmy, Renderer& my_renderer, float Deltatime, Player& player)
{
...
ExplosiveTower::ExplosiveTower(sf::Vector2i cellPosition)
{
...
void ExplosiveTower::ShootAt(int index, Renderer& my_renderer, float b, float Deltatime)
{
